...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><pre><code>SELECT "country (ISO-639-1)", "daily smoker" <br>FROM smoking_of_tobacco_products <br>WHERE year IN ('2014', '2019') <br>AND "country (ISO-639-1)" IN ('DE', 'DK', 'PL', 'AT');</code></pre></td>
        ...
        <tr>
            ...
            <td><pre><code>SELECT year, "country (ISO-639-1)", obese<br>FROM body_mass_index<br>WHERE "country (ISO-639-1)" IN ('DE', 'DK', 'EE', 'FI', 'PL', 'AT')<br>ORDER BY year;</code></pre></td>
        ...
        <tr>
            ...
            <td><pre><code>SELECT<br>    MIN(aerobic) AS min_aerobic,<br>    AVG(aerobic) AS avg_aerobic,<br>    MAX(aerobic) AS max_aerobic,<br>    MIN("muscle-strengthening") AS min_muscle_strengthening,<br>    AVG("muscle-strengthening") AS avg_muscle_strengthening,<br>    MAX("muscle-strengthening") AS max_muscle_strengthening,<br>    MIN("aerobic and muscle-strengthening") AS min_aerobic_and_strengthening,<br>    AVG("aerobic and muscle-strengthening") AS avg_aerobic_and_strengthening,<br>    MAX("aerobic and muscle-strengthening") AS max_aerobic_and_strengthening<br>FROM health_enhancing_physical_activity<br>WHERE year = '2019';</code></pre></td>
        ...
        <tr>
            ...
            <td><pre><code>SELECT "country (ISO-639-1)", "never or not in the last 12 months" <br>FROM alcohol_consumption <br>WHERE year = '2014' <br>ORDER BY "never or not in the last 12 months" DESC <br>LIMIT 5;</code></pre></td>
